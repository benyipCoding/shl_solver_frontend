...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 text-gray-900 dark:text-gray-50 selection:bg-indigo-100 selection:text-indigo-900 dark:selection:bg-indigo-900 dark:selection:text-indigo-100 transition-colors duration-300">
      {/* 导航栏 */}
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-white/70 dark:bg-slate-950/70 border-b border-gray-100 dark:border-slate-800 transition-colors duration-300">
      ...
      <main>
        ...
        <section className="relative overflow-hidden pt-20 pb-20 lg:pt-32 lg:pb-32">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-sm font-medium mb-8 border border-indigo-100 dark:border-indigo-800 shadow-sm animate-fade-in-up">
            ...
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-10 leading-relaxed font-light">
              ...
              逻辑推理辅助到智能验单助手，我们致力于为您提供更高效的解决方案。
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6 font-medium bg-red grow">
                  专为逻辑测试设计的 AI
              ...
              {/* Card 3: 占位符 - 简历优化 */}
              <div className="relative bg-white dark:bg-slate-900 p-8 rounded-2xl border border-dashed border-gray-300 dark:border-slate-700 flex flex-col hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors">
                <div className="w-14 h-14 bg-gray-100 dark:bg-slate-800 rounded-xl flex items-center justify-center mb-6">
                  <Layers className="h-7 w-7 text-gray-400 dark:text-gray-500" />
                </div>
                <h3 className="text-xl font-bold text-gray-500 dark:text-gray-400 mb-3">
                  简历智能优化
                </h3>
                <p className="text-gray-500 dark:text-gray-400 leading-relaxed mb-6 grow">
                  上传简历，AI
                  为您分析关键词匹配度，提供修改建议，让您的简历在筛选中脱颖而出。
                </p>
                <div className="mt-auto pt-4">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-gray-100 dark:bg-slate-800 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-slate-700">
                    开发中
                  </span>
                </div>
              </div>
