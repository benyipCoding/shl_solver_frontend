...
export const ff14Styles = {
  ...
  parseChip:
    "inline-block rounded-full border border-transparent px-2.5 py-[3px] text-[0.73rem]",
  activeChip:
    "inline-flex items-center rounded-full border border-[rgba(136,224,218,0.42)] bg-[rgba(34,110,108,0.3)] px-2.5 py-[3px] text-[0.73rem] text-[#c9fffb]",
  roleTank:
...
export const TEXT: Record<Locale, StaticText> = {
  ...
  en: {
    ...
    top10Average: "cast avg",
    top10HitsAverage: "avg hits",
    top10Damage: "avg dmg",
    delta: "Cast delta",
    hitDelta: "Hit delta",
