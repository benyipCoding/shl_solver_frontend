    ...
    <div className="relative flex-1 flex">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute right-0 mt-2 w-72 max-w-[calc(100vw-2rem)] bg-white rounded-xl shadow-xl border border-slate-100 p-2 z-20 animate-fade-in-up origin-top-right">
